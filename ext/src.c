...
zend_class_entry *src_testclass_ce;

ZEND_DECLARE_MODULE_GLOBALS(src)
...
#ifndef ZEPHIR_RELEASE
static PHP_MSHUTDOWN_FUNCTION(src)
{
 ...
 */
static void php_zephir_init_globals(zend_src_globals *zephir_globals TSRMLS_DC)
{
...
static PHP_RINIT_FUNCTION(src)
{

	zend_src_globals *zephir_globals_ptr = ZEPHIR_VGLOBAL;
...
static PHP_RSHUTDOWN_FUNCTION(src)
{
...
static PHP_MINFO_FUNCTION(src)
{
	php_info_print_box_start(0);
	php_printf("%s", PHP_SRC_DESCRIPTION);
	php_info_print_box_end();

	php_info_print_table_start();
	php_info_print_table_header(2, PHP_SRC_NAME, "enabled");
	php_info_print_table_row(2, "Author", PHP_SRC_AUTHOR);
	php_info_print_table_row(2, "Version", PHP_SRC_VERSION);
	php_info_print_table_row(2, "Powered by Zephir", "Version " PHP_SRC_ZEPVERSION);
	php_info_print_table_end();


}

static PHP_GINIT_FUNCTION(src)
{
	php_zephir_init_globals(src_globals TSRMLS_CC);
}

static PHP_GSHUTDOWN_FUNCTION(src)
{

}

zend_module_entry src_module_entry = {
