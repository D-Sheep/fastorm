...
static PHP_METHOD(Fastorm_Db_Connection, isConnected) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "connected", 8246182202184985080UL);
...
static PHP_METHOD(Fastorm_Db_Connection, getConfig) {
	...
	if (Z_TYPE_P(key) == IS_NULL) {
		RETURN_MEMBER_QUICK(this_ptr, "config", 229462175251419UL);
	} else {
...
static PHP_METHOD(Fastorm_Db_Connection, query) {
	...
	_0 = Z_TYPE_P(metadata) == IS_OBJECT;
	if (_0) {
...
static PHP_METHOD(Fastorm_Db_Connection, nativeQuery) {
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(e, SL("DbException") TSRMLS_CC)) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(e, "fastorm/db/Connection.zep", 278 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
...
static PHP_METHOD(Fastorm_Db_Connection, getAffectedRows) {
	...
	if (_4) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(fastorm_db_dbexception_ce, "Cannot retrieve number of affected rows.", "fastorm/db/Connection.zep", 297);
		return;
	}
	RETURN_CCTOR(rows);
...
static PHP_METHOD(Fastorm_Db_Connection, getInsertId) {
	...
	if (id < 1) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(fastorm_db_dbexception_ce, "Cannot retrieve last generated ID.", "fastorm/db/Connection.zep", 318);
		return;
	}
	RETURN_MM_LONG(id);
...
static PHP_METHOD(Fastorm_Db_Connection, begin) {
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(e, SL("DbException") TSRMLS_CC)) {
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "onevent", NULL, _3);
			zephir_check_call_status();
			zephir_throw_exception_debug(e, "fastorm/db/Connection.zep", 344 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
...
static PHP_METHOD(Fastorm_Db_Connection, commit) {
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(e, SL("DbException") TSRMLS_CC)) {
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "onevent", NULL, _3);
			zephir_check_call_status();
			zephir_throw_exception_debug(e, "fastorm/db/Connection.zep", 369 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
...
static PHP_METHOD(Fastorm_Db_Connection, rollback) {
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(e, SL("DbException") TSRMLS_CC)) {
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "onevent", NULL, _3);
			zephir_check_call_status();
			zephir_throw_exception_debug(e, "fastorm/db/Connection.zep", 394 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
...
static PHP_METHOD(Fastorm_Db_Connection, update) {
	...
	if (!(_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Arguments must be array or Traversable.", "fastorm/db/Connection.zep", 444);
		return;
	}
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "command",  NULL);
	zephir_check_call_status();
...
static PHP_METHOD(Fastorm_Db_Connection, insert) {
	...
	if (zephir_is_instance_of(args, SL("Traversable") TSRMLS_CC)) {
		...
		if (Z_TYPE_P(args) == IS_ARRAY == 0) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Arguments must be array or Traversable.", "fastorm/db/Connection.zep", 462);
			return;
		}
	}
...
static PHP_METHOD(Fastorm_Db_DbException, getSql) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "sql", 6385700277UL);
...
static PHP_METHOD(Fastorm_Db_DbException, getArgs) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "args", 210706796850UL);
...
static PHP_METHOD(Fastorm_Db_Query, getCommand) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "command", 7572251752186308UL);
...
static PHP_METHOD(Fastorm_Db_Query, getConnection) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "connection", 13869595640170944373UL);
...
static PHP_METHOD(Fastorm_Db_Result, getResultDriver) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "driver", 229463578766961UL);
...
static PHP_METHOD(Fastorm_Db_ResultIterator, key) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "pointer", 7572805637262822UL);
...
static PHP_METHOD(Fastorm_Db_ResultIterator, current) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "row", 6385662525UL);
...
static PHP_METHOD(Fastorm_ObjectMetadata, getTable) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "table", 6954047523885UL);
...
static PHP_METHOD(Fastorm_ObjectMetadata, getStorage) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "storage", 7572940188806586UL);
...
static PHP_METHOD(Fastorm_ObjectMetadata, getIdField) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "idField", 7572491725814070UL);
...
static PHP_METHOD(Fastorm_ObjectMetadata, getFields) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "fields", 229465804380252UL);
...
static PHP_METHOD(Fastorm_ObjectMetadata, getClassName) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "className", 8246177435899028604UL);
...
static PHP_METHOD(Fastorm_ObjectMetadata, getReflection) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "reflection", 13892093873600059696UL);
...
static PHP_METHOD(Fastorm_ObjectMetadata, getJoins) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "joins", 6953673027048UL);
...
static PHP_METHOD(Fastorm_ObjectQuery, getMetadata) {
	...
	RETURN_MEMBER_QUICK(this_ptr, "metadata", 249897954297663078UL);
